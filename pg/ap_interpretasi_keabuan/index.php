  ...
  <div class="wrapper">
    ...
    <section class="content-header">
      ...
      <label for="mulai">Tanggal :</label>
        ...
        <select name="blok" id="blok" value="<?php echo "$_GET[blok]"?>">
            <option value="A">A</option>
            <option value="B">B</option>
            <option value="C">C</option>
        </select>
        <label for="tray">Tray :</label>
        <select name="tray" id="tray" value="<?php echo "$_GET[tray]"?>">
...
JOIN 
  ds_layout
ON
  ds_layout.id_layout = ds_foto.id_layout
WHERE
    blok = '$blok' 
    AND tray = '$tray' 
  ";?>  
            ...
            options: {
                ...
                scales: {
                    ...
                    yAxes: [{
                        ...
                        scaleLabel: {
                            display: true,
                            labelString: 'Index Keabuan'
                        }
                    }]
                },
                title: {
                    display: true,
                    text: 'Index Keabuan Tanaman <?php echo "$_GET[blok]$_GET[tray]" ?> dari <?php echo "$_GET[dari] sampai $_GET[sampai]" ?>'
                }
            }
        };
