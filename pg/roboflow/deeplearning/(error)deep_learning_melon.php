            ...
            // Validate file type
                ...
                if (!in_array($mimeType, $allowedTypes)) {
                    ...
                    if (move_uploaded_file($tempPath, $rawImagePath)) {
                        ...
                        // Get selected model
                        $selectedModel = isset($_POST['model']) ? $_POST['model'] : 'combined';
                        $pythonPath = '/Users/syauqiarham/opt/anaconda3/bin/python3';
                        ...
                        switch($selectedModel) {
                            ...
                            case 'flower':
                                ...
                                break;
                            default:
                                $modelPath = $baseDir . '/app/content/Melon/deeplearning/combined.pt';
                                break;
                        }
...
try:
    model_path = os.path.abspath('$modelPath')
    upload_path = os.path.abspath('$rawImagePath')
    results_dir = os.path.abspath('$detectionFolder')
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="btn-group btn-group-toggle w-100" data-toggle="buttons">
                                    <label class="btn btn-outline-primary active">
                                        <input type="radio" name="model" value="combined" checked> 
                                        <i class="fas fa-object-group mr-1"></i>Combined
                                    </label>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body text-center">
                                                <img src="<?php echo htmlspecialchars('../../output/' . $detectionFolderName . '/raw_' . $originalName); ?>" 
                                                     ...
                                                     alt="Original Image" style="max-height: 300px; object-fit: contain;">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="card">
                                            ...
                                            <div class="card-body p-4 text-center">
                                                <img src="<?php echo htmlspecialchars($resultImage); ?>" 
                                                     ...
                                                     alt="Detection Result" style="max-height: 300px; object-fit: contain;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                                        ...
                                                                        <div class="card card-body border-0">
                                                                            <div class="row">
                                                                                <div class="col-md-4">
                                                                                    ...
                                                                                    <img src="../../output/<?php echo basename($detectionFolder); ?>/<?php echo htmlspecialchars($detection['cropped_image']); ?>" 
